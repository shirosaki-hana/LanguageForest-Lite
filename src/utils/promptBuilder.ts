 ...
 */
export function buildTranslationMessages(sourceText: string, pairId: string = DEFAULT_PAIR_ID): OllamaChatMessage[] {
  ...
  return [
    ...
    {
      role: 'user',
      content: pair.dictionary,
    },
    {
      role: 'assistant',
      content: pair.greeting,
    },
    {
      role: 'user',
      content: `${pair.requestUpper}
${sourceText}
${pair.requestLower}
      `,
    },
